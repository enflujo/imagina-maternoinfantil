 ...
 *
 * @param {string} valor Texto crudo donde se van a buscar enlaces.
 * @returns {string} El mismo texto pero con enlaces convertidos a HTML.
 */
export const urlsAEnlacesHTML = (valor) => {
