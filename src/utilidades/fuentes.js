export default [
  ...
  },
  {
    ...
    serieDisponible: [],
    interpretacion:
      'Un valor de 98% indica que 98 partos de cada 100 nacimientos en un lugar y momento específico ocurren en instituciones de salud. La atención institucional del parto es una de las medidas básicas para disminuir la mortalidad materna y perinatal. No obstante, el parto debe ser atendido en condiciones de calidad y con personal entrenado para que se disminuya la posibilidad de complicaciones en el momento del alumbramiento. La situación ideal es que los partos se den en espacios institucionales y por personal calificado, sin embargo, recientemente la Corte Constitucional reconoció la partería como un saber ancestral y patrimonial. Existe un deber constitucional y legal de integrar la partería como forma de medicina ancestral al Sistema General de Seguridad Social en Salud.',
  ...
  },
  {
    ...
    serieDisponible: [],
    interpretacion:
      'Un valor de 17% indica que 17 de cada 100 nacidos vivos han sido partos atendidos por cesárea, en un momento y territorio determinado. La cesárea solo debe ocurrir cuando se encuentra justificada desde el punto de vista médico y así disminuir el riesgo de complicaciones y muerte de la gestante y el recién nacido. En situaciones como el parto prolongado, sufrimiento fetal está recomendada la cesárea.  Un informe de la Organización Mundial de la Salud reportó que 1 de cada 5 partos se realiza por cesárea. La cesárea es un procedimiento quirúrgico que puede conllevar a riesgos como todos los procedimientos de este tipo y más si no es necesario. Mayor información: https://www.who.int/news/item/16-06-2021-caesarean-section-rates-continue-to-rise-amid-growing-inequalities-in-access ',
  ...
  },
  {
    ...
    nombreIndicador: 'Proporción de nacidos vivos hijos de mujeres menores de 14 años',
    definicion:
  ...
  },
  {
    ...
    nombreIndicador: 'Proporción de nacidos vivos hijos de mujeres menores de 14 - 17 años',
    definicion:
  ...
  },
  {
    ...
    meta: {
      umbral: 12,
      descripcion:
        'A 2021 se habrá disminuido la mortalidad infantil nacional ajustada a 12 por 1.000 nacidos vivos o menos. ODS 2030 A 14 por 1000',
    },
  },
  {
    ...
    serieDisponible: [],
    interpretacion:
      'Un valor de 3, indica que murieron 3 niños por infección respiratoria aguda por cada 100.000 niños menores de 5 años en un momento y territorio dado.',
  ...
  },
  {
    ...
    meta: {
      umbral: 12,
      descripcion:
        'De acuerdo con las metas de los Objetivos de Desarrollo Sostenible se espera que a 2030 se reduzca en los países a menos de 12 muertes por cada 1.000 nacidos vivos.',
    },
  },
  {
