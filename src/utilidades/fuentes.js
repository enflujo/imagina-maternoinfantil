export default [
  {
    ...
    interpretacion: [
      ...
      'Un valor de 8% significa que existen 8 nacidos a término con bajo peso al nacer por cada 100 nacidos vivos en un territorio y momento específicos. Más información sobre la importancia del adecuado peso al nacer: https://apps.who.int/iris/bitstream/handle/10665/255733/WHO_NMH_NHD_14.5_spa.pdf',
    ],
    meta: {
      umbral: 10,
  ...
  },
  {
    ...
    serieDisponible: [],
    interpretacion: [
      'Un embarazo en una niña menor de 14 años se considera delito de acceso carnal abusivo, según el artículo 208 de la Ley 1236 de 2008. Usualmente la edad de los padres es mayor que la de las madres, lo cual sugiere que estos embarazos se asocian a abuso.',
      'Las relaciones sexuales con menores de 14 años son un delito, el reporte ante las autoridades competentes es un deber ciudadano para garantizar atención y acompañamiento oportunos de la menor.',
    ],
    meta: {
      umbral: 0,
  ...
  },
  {
    ...
    serieDisponible: [],
    interpretacion: [
      'Un valor de 98% indica que 98 partos de cada 100 nacimientos en un lugar y momento específicos ocurren en instituciones de salud.',
      'La atención institucional del parto es una de las medidas básicas para disminuir la mortalidad materna y perinatal. No obstante, el parto debe ser atendido en condiciones de calidad y con personal entrenado para que disminuya la posibilidad de complicaciones en el momento del alumbramiento. Las 24 horas posteriores al nacimiento son vitales tanto para la madre como para el bebé, por ello, es importante que durante ese tiempo reciban seguimiento y atención médica.',
      'Recientemente la Corte Constitucional reconoció la partería como un saber ancestral y patrimonial. Existe un deber constitucional y legal de integrar la partería como forma de medicina ancestral al Sistema General de Seguridad Social en Salud. Las parteras constituyen una fuente de educación sexual y planificación familiar en zonas en donde el acceso a los servicios de salud es muy limitado. Mas información: Sentencia T-128-22 https://www.corteconstitucional.gov.co/noticia.php?Corte-Constitucional-reconoce-la-parter%C3%ADa-como-saber-ancestral-y-patrimonio-cultural-de-la-Naci%C3%B3n,-exhorta-al-Ministerio-de-Salud-a-integrar-a-las-parteras-al-Sistema-de-Seguridad-Social-en-Salud-y-al-Congreso-a-legislar-sobre-este-tema-9274',
    ],
    meta: {
      umbral: null,
  ...
  },
  {
    ...
    serieDisponible: [],
    interpretacion: [
      'Un valor de 17% indica que 17 de cada 100 nacidos vivos han sido partos atendidos por cesárea, en un momento y territorio determinados. Esta solo debe ocurrir cuando se encuentra justificada desde el punto de vista médico para disminuir el riesgo de complicaciones y muerte de la gestante y el recién nacido, por ejemplo en situaciones como el parto prolongado o el sufrimiento fetal.',
      'Un informe de la Organización Mundial de la Salud reportó que 1 de cada 5 partos se realiza por cesárea. La cesárea es un procedimiento quirúrgico que tiene riesgos, al igual que todos los procedimientos de este tipo, especialmente si no es necesaria.',
      'Mayor información: https://www.who.int/news/item/16-06-2021-caesarean-section-rates-continue-to-rise-amid-growing-inequalities-in-access Epidemia de cesáreas en Colombia: https://repositorio.uniandes.edu.co/bitstream/handle/1992/59067/Trabajo%20de%20grado_Epidemia%20de%20ces%c3%a1reas%20en%20Colombia_A%20De%20la%20Torre_FINAL.pdf?sequence=3&isAllowed=y',
    ],
    meta: {
      umbral: null,
  ...
  },
  {
    ...
    serieDisponible: [],
    interpretacion: [
      'Un valor de 15% indica que ocurrieron 15 nacimientos en madres menores de entre 14 y 17 años por cada 100 nacidos vivos, en un territorio y momento específicos.',
      'La prevención del embarazo en la adolescencia es una responsabilidad compartida. En primer lugar, la educación sexual y reproductiva es fundamental, no solamente para que los adolescentes tengan relaciones sexuales seguras y accedan a métodos de planificación, sino para que puedan tomar decisiones informadas y consientes sobre sus propios cuerpos. En segundo lugar, una educación sexual con enfoque de género puede garantizar que se ejerzan menos violencias dentro de las relaciones sexuales y sentimentales y que las personas que son violentadas de alguna forma, puedan identificar con más facilidad los canales de atención, apoyo y denuncia.',
  ...
  },
  {
    ...
    interpretacion: [
      ...
      'La mortalidad materna es más frecuente en las regiones apartadas y de difícil acceso a los servicios sanitarios. Los determinantes sociales de la mortalidad materna se encuentran relacionados con el área geográfica, existiendo una diferencia sustancial entre áreas rurales y urbanas, y con la pertenencia étnica.',
      'Según el informe del Instituto de Salud Pública sobre mortalidad materna de 2019, las razones más altas se encuentran en áreas geográficas asociadas a grupos poblacionales étnicos. Adicionalmente, los mayores casos se presentan en el régimen subsidiado de salud.',
      'Lo anterior hace un llamado a prestar especial atención a factores sociales que influyen en las condiciones de vida de las madres; como la educación, la situación económica y el acceso a servicios de salud. Fuente: Informe de evento. Mortalidad materna, Colombia 2019. Instituto Nacional de Salud.',
    ],
    meta: {
      umbral: 45,
      descripcion: [
        'Ninguna muerte materna es aceptable, sin embargo, de acuerdo con el Plan Decenal de Salud pública, los casos anuales no deben superar 150 muertes en el país.',
        'El CONPES 140 de 2011 definió las metas y estrategias del país para el logro del objetivo, estableciendo como meta nacional reducir la razón de mortalidad materna a 45 muertes maternas por 100.000 nacidos vivos.',
        'Según los Objetivos de Desarrollo Sostenible a 2030, se reducirá a 32 la mortalidad materna por cada 100.000 nacidos vivos.',
      ],
      tendenciaDeseada: 'abajo',
    },
    limitacion: '',
  },
  {
    ...
    meta: {
      umbral: 61,
      descripcion: [
        'De acuerdo con el Plan Decenal de Salud Pública debería estar por debajo de 61 nacimientos por cada 1.000 mujeres de 10 a 14 años para Colombia.',
  ...
  },
  {
    ...
    meta: {
      umbral: null,
      descripcion: [
        'No existe una meta específica sobre este tipo de infecciones excepto para VIH y sífilis congénita.',
      ],
      tendenciaDeseada: 'abajo',
    },
    limitacion: '',
  ...
  },
  {
    ...
    serieDisponible: [],
    interpretacion: [
      'Un valor de 20% indica que 20 de cada 100 personas fueron atendidas por servicios de salud relacionados con la anticoncepción en un momento y territorio específicos.',
