export default [
  {
    ...
    tipo: 'proporción',
    calculo:
      'Número de nacidos vivos a término (37 semanas o más) que pesaron menos de 2.499 gramos / Total de nacidos vivos en el mismo periodo y territorio.',
    fuenteNumerador: 'CUBO INDICADORES EEVV: Nacidos vivos a término que pesaron menos de 2.499 gramos.',
    ...
    nivelDesagregacion: ['Departamental y Municipal', 'Etnia'],
    serieDisponible: [],
    interpretacion: [
  ...
  },
  {
    ...
    nombreIndicador:
      'Proporción de nacidos vivos de madres menores de 15 años cuyo padre es mayor 4 años o más que la madre',
    definicion:
      'Indica la proporción de nacidos vivos de madres menores de 15 años cuyo padre es mayor 4 años o más que la madre, con respecto al total de nacimientos en un periodo y territorio definidos.',
    grupo: 'Salud sexual y reproductiva.',
    tipo: 'proporción',
    calculo:
  ...
  },
  {
    ...
    interpretacion: [
      ...
      'La mortalidad perinatal se relaciona con la atención prenatal, el acceso a los servicios de salud, las condiciones sociales y biológicas de la persona gestante. Además, es uno de los indicadores que más afecta la mortalidad en menores de 1 año. Una de las causas más frecuentes es un inadecuado desarrollo del feto, infecciones recurrentes durante el embarazo, diabetes gestacional y preeclampsia.',
  ...
  },
  {
    ...
    meta: {
      umbral: 4.08,
      descripcion: [
        'Según el "Plan Decenal de Salud Pública" (PDSP) se esperaba reducir la mortalidad infantil evitable por desnutrición en forma progresiva el 30% en el 2013, 50% en el 2015 y 100% en 2020.',
      ],
      tendenciaDeseada: 'abajo',
    },
    limitacion: '',
